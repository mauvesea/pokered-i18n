...
; Actual characters (from other graphics files)
	...
	; needed for ShowPokedexDataInternal (see engine/menus/{LANGUAGE}/pokedex.asm)
	charmap "′",         $60 ; gfx/pokedex/pokedex.png
	charmap "″",         $61 ; gfx/pokedex/pokedex.png
	charmap "<M>",       $60 ; German gfx/pokedex/pokedex.png
	charmap "<K>",       $61 ; German gfx/pokedex/pokedex.png
	charmap "<G>",       $62 ; German gfx/pokedex/pokedex.png
